import { ExperiencesTab } from "@/features/experiences/ExperiencesTab";
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        <header className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
            A dynamic CV tailored to job offers starts with a complete and accurate work history. Build yours.
          </p>
        </header>

...
import type { TimelineColor } from '@/types/timelineType';
      ...
      >
        ...
        <TimelineContent>
          ...
          <div className='grid grid-flow-col grid-rows-1'>
            <TimelineTime className="pr-2">{dateStart}</TimelineTime>
            -
            <TimelineTime className="pl-2">{dateEnd}</TimelineTime>
            </div>
...
export {
  Timeline, TimelineConnector, TimelineContent, TimelineDescription, TimelineEmpty, TimelineHeader, TimelineIcon, TimelineItem, TimelineTime, TimelineTitle
};
